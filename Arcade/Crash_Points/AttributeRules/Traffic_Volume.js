/* 
For this I think that we need to set up a attribute rule or python script to update the ADA_RoadCenterline table with the traffic count data.
AND then we can use this Arcade script to pull the traffic count data from the ADA_RoadCenterline table.
*/
...
var road_fs = FeatureSetByName($datastore, "ACHD_TrafficCounts", ["OBJECTID","Count"], true);
